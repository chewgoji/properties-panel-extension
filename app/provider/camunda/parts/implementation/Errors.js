...
function getErrorsHeading(element, bpmnFactory, options) {
  ...
  function createElement() {
    ...
    var newElem = elementHelper.createElement('activiti:ErrorEventDefinition', {}, extensionElements, bpmnFactory);
...
function getErrors(bo) {
  return extensionElementsHelper.getExtensionElements(bo, 'activiti:ErrorEventDefinition') || [];
}
