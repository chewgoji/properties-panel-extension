...
module.exports = function(parameter, bpmnFactory, options, translate) {
  ...
  entries.push(entryFactory.validationAwareTextField(translate, {
    ...
    label: is(parameter, 'activiti:InputParameter') ?
  ...
  entries.push(entryFactory.table(translate, {
    ...
    addElement: function(element, node) {
      var newValue = createElement('activiti:Value', getParameter().definition, bpmnFactory, { value: undefined });
  ...
  entries.push(entryFactory.table(translate, {
    ...
    addElement: function(element, node) {
      var newEntry = createElement('activiti:Entry', getParameter().definition, bpmnFactory, { key: undefined, value: undefined });
