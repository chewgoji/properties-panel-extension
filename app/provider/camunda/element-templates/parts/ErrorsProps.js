...
var Activiti_ERROR_EVENT_DEFINITION_TYPE = 'Activiti:errorEventDefinition';
...
module.exports = function(group, element, elementTemplates, bpmnFactory, translate) {
  ...
  function renderError(id, templateProperty) {
    ...
    var bo = getBusinessObject(element),
        errorEventDefinitions = findExtensions(bo, [ 'Activiti:ErrorEventDefinition' ]);
    ...
    var getError = function() {
      var definition = findActivitiErrorEventDefinition(element, bindingErrorRef);
  ...
  var errors = filter(template.properties, function(p) {
    return !p.type && p.binding.type === Activiti_ERROR_EVENT_DEFINITION_TYPE;
  });
